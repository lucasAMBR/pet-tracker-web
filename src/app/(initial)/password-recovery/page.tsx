    ...
    return(
        <div className="w-screen h-screen flex p-6 bg-neutral-100 dark:bg-neutral-900 items-center justify-center flex-col">
            ...
            <div className="flex flex-col items-center">
                ...
                <p className="max-w-[450px] mb-6 text-center">We will send a password reset link to your email, please do not share it with anyone.</p>
            </div>
            <form className="flex flex-col gap-3 w-[450px]">
                <Input 
                    ...
                    className="w-full" 
                />
                <Button type="submit" className="cursor-pointer">Send recovery code</Button>
            </form>
        </div>
    );
}
